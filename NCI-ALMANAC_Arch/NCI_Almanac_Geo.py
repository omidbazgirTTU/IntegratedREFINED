...
SAVE_PATH = "/home/obazgir/REFINED/Volumetric_REFINED/DistanceBased/NCI_Almanac/GeoNonMetricMDS20/"
...
for i in range(20):
    ...
    import pickle
    # Geometric
    with open('/home/obazgir/REFINED/Volumetric_REFINED/DistanceBased/theMapping_Init_Geometric_DistBased20_NonMetric.pickle','rb') as file:
    ...
    for mdl in MODELS:
        ...
        def CNN_model(Width,Height):
            ...
            x1 = layers.Conv2D(34, (nb_conv, nb_conv),padding='valid',strides=2,dilation_rate=1)(x1)
            x1 = layers.BatchNormalization()(x1)
            x1 = layers.Activation('relu')(x1)
            x1 = layers.Conv2D(40, (1,1),padding='valid',strides=1,dilation_rate=1)(x1)
            ...
            y1 = layers.Conv2D(34, (nb_conv, nb_conv),padding='valid',strides=2,dilation_rate=1)(y1)
            y1 = layers.BatchNormalization()(y1)
            y1 = layers.Activation('relu')(y1)
            y1 = layers.Conv2D(40, (1,1),padding='valid',strides=1,dilation_rate=1)(y1)
            Out2 = layers.Flatten()(y1)
            
            x = layers.concatenate([Out1, Out2])
            
            x = layers.Dense(149)(x)
...
#            x = layers.Dropout(1- 0.7)(x)
            ...
            initial_learning_rate =  0.0007985920509647954
            lr_schedule = tf.keras.optimizers.schedules.ExponentialDecay(
                initial_learning_rate,
                decay_steps=  210326,
                decay_rate=   0.8379303448836831,
                staircase=True)
