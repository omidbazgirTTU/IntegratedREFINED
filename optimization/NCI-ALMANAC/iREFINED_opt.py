...
def CNN_model(Width,Height,params):
    ...
    x1 = layers.Conv2D(int(params['Kernels1']), kernel_size = (int(params['kernel_size1']),int(params['kernel_size1'])),padding='valid',strides=int(params['strides1']),dilation_rate=1)(input1)
    x1 = layers.BatchNormalization()(x1)
    x1 = layers.Activation('relu')(x1)
    x1 = layers.Conv2D(int(params['Kernels2']), kernel_size = (int(params['kernel_size2']),int(params['kernel_size2'])),padding='valid',strides=int(params['strides2']),dilation_rate=1)(x1)
    x1 = layers.BatchNormalization()(x1)
    x1 = layers.Activation('relu')(x1)
    ...
    y1 = layers.Conv2D(int(params['Kernels1']), kernel_size = (int(params['kernel_size1']),int(params['kernel_size1'])),padding='valid',strides=int(params['strides1']),dilation_rate=1)(input2)
    y1 = layers.BatchNormalization()(y1)
    y1 = layers.Activation('relu')(y1)
    y1 = layers.Conv2D(int(params['Kernels2']), kernel_size = (int(params['kernel_size2']),int(params['kernel_size2'])),padding='valid',strides=int(params['strides2']),dilation_rate=1)(y1)
    y1 = layers.BatchNormalization()(y1)
    y1 = layers.Activation('relu')(y1)
...
param_hyperopt = {
    ...
    #'Kernels3': hp.uniform('Kernels3', 1, 64),
    ...
    'units1': hp.quniform('units1', 20, 400, 100),
    #'units2': hp.quniform('units2', 10, 100, 20),
    }
